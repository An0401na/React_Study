...
function Summary(props) {
  ...
  const correctPercentage = getPercentage(correctAnswers) || 0;
  const wrongPercentage = getPercentage(wrongAnswers) || 0;
  const skippedPercentage = getPercentage(skippedAnswers) || 0;
